  ...
  return (
    <div className="flex flex-col my-10 border border-black rounded-lg">
      <div className="flex flex-row m-10">
        ...
        <table className="table ml-10">
          <tbody>
            ...
            <tr>
              <td>Giá thuê(VND): {bikeInfo.price}</td>
            </tr>
            <tr>
        ...
        >
          <DialogTitle id="alert-dialog-title">{"Xác nhận xóa xe"}</DialogTitle>
          <DialogContent>
      ...
      <div className="flex flex-row">
        <button
          className="w-full h-10 bg-red-300 hover:bg-red-500 rounded-bl-lg text-lg font-medium"
          onClick={handleClickOpen}
        >
          Xóa
        </button>
        <button
          className="w-full h-10 bg-yellow-300 hover:bg-yellow-500 rounded-br-lg text-lg font-medium"
